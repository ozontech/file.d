...
func TestRename(t *testing.T) {
	config := &Config{"field_1": "renamed_field_1", "field_2": "renamed_field_2", "field_4.field_5": "renamed_field_5", "field_5": "renamed_field_2", "override":false}
	...
	input.In(0, "test.log", 0, []byte(`{"field_2":"value_2","field_5":"value_5"}`))
	...
	assert.Equal(t, "value_2", outEvents[4].Root.Dig("renamed_field_2").AsString(), "wrong field value")
	...
	assert.NotNil(t, outEvents[4].Root.Dig("field_5"), "field is nil")
}
