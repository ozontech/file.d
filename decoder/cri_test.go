...
func TestParseLogFilename(t *testing.T) {
	metaInfo := NewCRIMetaInformation("/k8s-logs/advanced-logs-checker-1566485760-trtrq_sre_duty-bot-4e0301b633eaa2bfdcafdeba59ba0c72a3815911a6a820bf273534b0f32d98e0.log")
...
func TestParseLogFilenameError(t *testing.T) {
	metaInfo := NewCRIMetaInformation("web-logs-filed")
