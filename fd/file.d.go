...
func (f *FileD) startPipelines(mux *http.ServeMux) {
...
func (f *FileD) addPipeline(mux *http.ServeMux, name string, config *cfg.PipelineConfig) {
...
func (f *FileD) startHTTP() *http.ServeMux {
	if f.httpAddr == "off" {
		return nil
	}
