...
import (
	...
	_ "github.com/ozontech/file.d/plugin/output/http"
	...
	testsList := []E2ETest{
		...
		},
		{
			...
			e2eTest: &file_elasticsearch.Config{
				...
				ActiveEndpoints: []string{"http://localhost:19200"},
				Username:        "elastic",
				Password:        "elastic",
			},
		...
		},
		{
			...
			e2eTest: &file_elasticsearch.Config{
				...
				ActiveEndpoints: []string{"http://localhost:19200", "http://localhost:19201"},
				Username:        "elastic",
				Password:        "elastic",
			},
